...
import { GetPassengersAPI, PostPassenger,PostEditPassenger,ViewTourPassengersAdmin,ViewTransactionsAdmin,EditPassengerAdmin} from '../controllers/passengercontroller.js';
...
import { GetItineraryAPI, AddItinerary, AddItineraryAPI } from '../controllers/itinerarycontroller.js';
...
router.post('/editpassenger',upload.single("idproof"),PostEditPassenger)
...
router.get('/admin/editpassenger/:id',EditPassengerAdmin)
router.get('/admin/AddItinerary',AddItinerary)
...
router.post('/additinerary/',AddItineraryAPI)
